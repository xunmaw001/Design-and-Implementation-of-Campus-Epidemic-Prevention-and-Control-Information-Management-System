    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">校园疫情防控信息管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                       <!--<el-form-item class="input" label="用户类型">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.yonghuTypes" placeholder="请选择用户类型">
                                <el-option
                       ...
                       <!--<el-form-item class="input" label="管控状态">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.yonghuGuankongTypes" placeholder="请选择管控状态">
                                <el-option
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // }
                            // yonghu 中的 用户类型 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuTypes== null ||this.ruleForm.yonghuTypes== "")){
                            //     this.$message.error("用户类型不能为空");
                            //     return
                            // }
                            // yonghu 中的 管控状态 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuGuankongTypes== null ||this.ruleForm.yonghuGuankongTypes== "")){
                            //     this.$message.error("管控状态不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/xiaoyuanyiqingfangkongxinxiguanlixitong/img/back-img-bg.jpg);
