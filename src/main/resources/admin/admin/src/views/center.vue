  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='用户类型' prop="yonghuTypes">
                 <el-select v-model="ruleForm.yonghuTypes"  placeholder='请选择用户类型'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='管控状态' prop="yonghuGuankongTypes">
                 <el-select v-model="ruleForm.yonghuGuankongTypes"  placeholder='请选择管控状态'>
                     <el-option
...
// 注册表 用户 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuGuankongTypes)&& 'yonghu'==this.flag){
