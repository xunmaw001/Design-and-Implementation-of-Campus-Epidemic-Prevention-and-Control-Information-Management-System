        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="用户类型" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择用户类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="管控状态" prop="yonghuGuankongTypes">
                        <el-select v-model="ruleForm.yonghuGuankongTypes" :disabled="ro.yonghuGuankongTypes" placeholder="请选择管控状态">
                            <el-option
                                v-for="(item,index) in yonghuGuankongTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuGuankongTypes: [
                              { required: true, message: '管控状态不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_guankong_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yonghuGuankongTypesOptions = data.data.list;
                    }
                });
