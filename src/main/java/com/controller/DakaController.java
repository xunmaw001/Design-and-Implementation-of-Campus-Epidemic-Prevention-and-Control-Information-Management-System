    ...
    */
    ...
    public R save(@RequestBody DakaEntity daka, HttpServletRequest request){
        ...
        Wrapper<DakaEntity> queryWrapper = new EntityWrapper<DakaEntity>()
            ...
            .eq("daka_jiuzhen", daka.getDakaJiuzhen())
            .eq("daka_types", daka.getDakaTypes())
            .eq("daka_delete", 1)
            ;
...
//            daka.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if("".equals(daka.getDakaText()) || "null".equals(daka.getDakaText())){
                daka.setDakaText(null);
        }
...
//                            dakaEntity.setDakaJiuzhen(data.get(0));                    //就诊情况 要改的
//                            dakaEntity.setDakaTypes(Integer.valueOf(data.get(0)));   //疫情状态 要改的
